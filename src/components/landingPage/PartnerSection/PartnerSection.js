    ...
    return (
        <div className='bg-lightblue' id='partners'>
            <div className='main-container flex flex-col items-center gap-12 lg:flex-row pt-32 pb-32'>
                ...
                <div className='w-full lg:w-3/5 xl:w-1/2 text-black font-deafult'>
                    <h2 className='section-header'>Partnering with us to digitize the Blue Food ecosystem</h2>
                    <p className='text-sm font-normal mt-7 leading-tight '>We leverage technology to scale the Bangladesh Ocean Fisheries and Marine Aquaculture Industries and make them more rewarding for all of its stakeholders, including Fishermen, Harvesters, Factories, and Consumers.</p>
