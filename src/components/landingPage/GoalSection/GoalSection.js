    ...
    return (
        <div className='bg-[#001021]' id='goals'>
            <div className='main-container pb-[120px] flex flex-col items-center font-default'>
                ...
                <p className='text-sm w-full lg:w-2/3 text-center font-normal text-white mt-7 leading-tight'>We enable finance for small-scale fisheries and aquaculture and leverage technology to streamline the global Blue Food ecosystem powered by phygital distribution.</p>
