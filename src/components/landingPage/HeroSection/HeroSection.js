        ...
        <div className='banner-container' onDoubleClick={hideResources} id='home'>
            ...
            <div className=''>
                ...
                <div className='main-container content-top-banner flex flex-col items-start pt-12'>
                    <h1 className='text-[2.5rem] md:text-xxl font-extrabold font-default text-start mt-24 text-white leading-tight md:leading-[96px] w-full sm:w-4/5 lg:w-2/3'>Sailing the Blue Revolution</h1>
